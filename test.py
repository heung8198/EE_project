if __name__ == '__main__':
    ...
    station = [593, 592, 591, 590, 588, 584, 577, 576, 575, 574, 573, 571, 555, 553, 552, 551, 549, 548, 546, 544,
               543,
               542, 540, 539, 516, 515, 505, 502, 501, 500, 3886, 3882, 3881, 3880, 3879, 3878, 3873, 3868, 3865,
               3864,
        ...
        for i in range(25):
            ...
            for st in station:
                if st not in :
                    ...
                    data.append({'대여일자': date, '대여시간': i, '대여소번호': st, '대여소명': station_name1, '이용건수': 0})
            bike = pd.concat([bike, pd.DataFrame(data)], ignore_index=True)
        print(1)